...
ur_usm_pool_handle_t_::createUMFPoolForDesc(usm::pool_descriptor &Desc,
  ...
  case UR_USM_TYPE_HOST: {
    std::tie(UmfRet, MemProvider) =
        umf::memoryProviderMakeUnique<CudaUSMHostMemoryProvider>(Desc);
    break;
  }
  case UR_USM_TYPE_DEVICE: {
    std::tie(UmfRet, MemProvider) =
        umf::memoryProviderMakeUnique<CudaUSMDeviceMemoryProvider>(Desc);
    break;
  }
  case UR_USM_TYPE_SHARED: {
    std::tie(UmfRet, MemProvider) =
        umf::memoryProviderMakeUnique<CudaUSMSharedMemoryProvider>(Desc);
    break;
  }
  default:
