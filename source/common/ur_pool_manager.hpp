...
struct pool_descriptor {
    ...
    static pool_descriptor create(ur_usm_pool_handle_t poolHandle,
                                  ur_context_handle_t hContext,
                                  ur_device_handle_t hDevice,
                                  ur_usm_type_t type,
...
inline pool_descriptor pool_descriptor::create(ur_usm_pool_handle_t poolHandle,
                                               ur_context_handle_t hContext,
                                               ur_device_handle_t hDevice,
                                               ur_usm_type_t type,
                                               const ur_usm_desc_t *pDesc) {
    pool_descriptor newDescriptor{};
    newDescriptor.hContext = hContext;
    newDescriptor.poolHandle = poolHandle;
    newDescriptor.type = type;
    newDescriptor.hDevice = hDevice;
