...
struct USMSaxpyKernelTests : uur::urExpUpdatableCommandBufferTests {
    void SetUp() override {
...
UUR_INSTANTIATE_DEVICE_TEST_SUITE_P(USMSaxpyKernelTests);

TEST_P(USMSaxpyKernelTests, UpdateParameters) {
    ...
    ur_exp_command_buffer_update_kernel_launch_desc_t update_desc = {
        ...
        new_input_descs, // pArgPointerList
