...
struct BufferSaxpyKernelTests : uur::urExpUpdatableCommandBufferTests {
    void SetUp() override {
        program_name = "saxpy";
...
UUR_INSTANTIATE_DEVICE_TEST_SUITE_P(BufferSaxpyKernelTests);

TEST_P(BufferSaxpyKernelTests, UpdateParameters) {
    ...
    ur_exp_command_buffer_update_kernel_launch_desc_t update_desc = {
        ...
        0,               // numExecInfos
        0,               // workDim
        new_input_descs, // pArgMemobjList
        nullptr,         // pArgPointerList
        &new_A_desc,     // pArgValueList
