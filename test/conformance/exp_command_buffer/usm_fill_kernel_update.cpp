...
struct USMFillCommandTest : uur::urExpUpdatableCommandBufferTests {
    void SetUp() override {
...
TEST_P(USMFillCommandTest, UpdateParameters) {
    ...
    ur_exp_command_buffer_update_kernel_launch_desc_t update_desc = {
        ...
        &new_output_desc, // pArgPointerList
...
TEST_P(USMFillCommandTest, UpdateExecInfo) {
    ...
    ur_exp_command_buffer_update_kernel_launch_desc_t update_desc = {
        ...
        new_exec_info_descs, // pArgExecInfoList
        nullptr,             // pGlobalWorkOffset
...
struct USMMultipleFillCommandTest : uur::urExpUpdatableCommandBufferTests {
    void SetUp() override {
        program_name = "fill_usm";
        UUR_RETURN_ON_FATAL_FAILURE(urExpUpdatableCommandBufferTests::SetUp());
